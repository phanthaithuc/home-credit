...
# -*- coding: utf-8 -*-
"""
Created on  August 18 04:16:08 2018
...
def application_train_test(num_rows = None, nan_as_category = False):
    # Read data and merge
    df = pd.read_csv('/home/thuc/Downloads/train-set/application_train.csv', nrows= num_rows)
    test_df = pd.read_csv('/home/thuc/Downloads/train-set/application_test.csv', nrows= num_rows)
...
def bureau_and_balance(num_rows = None, nan_as_category = True):
    bureau = pd.read_csv('/home/thuc/Downloads/train-set/bureau.csv', nrows = num_rows)
    bb = pd.read_csv('/home/thuc/Downloads/train-set/bureau_balance.csv', nrows = num_rows)
...
def previous_applications(num_rows = None, nan_as_category = True):
    prev = pd.read_csv('/home/thuc/Downloads/train-set/previous_application.csv', nrows = num_rows)
...
def pos_cash(num_rows = None, nan_as_category = True):
    pos = pd.read_csv('/home/thuc/Downloads/train-set/POS_CASH_balance.csv', nrows = num_rows)
...
def installments_payments(num_rows = None, nan_as_category = True):
    ins = pd.read_csv('/home/thuc/Downloads/train-set/installments_payments.csv', nrows = num_rows)
...
def credit_card_balance(num_rows = None, nan_as_category = True):
    cc = pd.read_csv('/home/thuc/Downloads/train-set/credit_card_balance.csv', nrows = num_rows)
...
def display_importances(feature_importance_df_):
    ...
    plt.tight_layout
    plt.savefig('/home/thuc/Downloads/outputs/lgbm_importances01.png')
