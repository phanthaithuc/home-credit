...
def application_train_test(num_rows = None, nan_as_category = False):
    # Read data and merge
    df = pd.read_csv('/valohai/inputs/train-set-2/application_train.csv', nrows= num_rows)
    test_df = pd.read_csv('/valohai/inputs/train-set-1/application_test.csv', nrows= num_rows)
...
def bureau_and_balance(num_rows = None, nan_as_category = True):
    bureau = pd.read_csv('/valohai/inputs/train-set-3/bureau.csv', nrows = num_rows)
    bb = pd.read_csv('/valohai/inputs/train-set-4/bureau_balance.csv', nrows = num_rows)
...
def previous_applications(num_rows = None, nan_as_category = True):
    prev = pd.read_csv('/valohai/inputs/train-set-7/previous_application.csv', nrows = num_rows)
...
def pos_cash(num_rows = None, nan_as_category = True):
    pos = pd.read_csv('/valohai/inputs/train-set-6/POS_CASH_balance.csv', nrows = num_rows)
...
def installments_payments(num_rows = None, nan_as_category = True):
    ins = pd.read_csv('/valohai/inputs/train-set-5/installments_payments.csv', nrows = num_rows)
...
def credit_card_balance(num_rows = None, nan_as_category = True):
    cc = pd.read_csv('/valohai/inputs/train-set-8/credit_card_balance.csv', nrows = num_rows)
